...
<td width="">
    	Current Timer for Java Exam Is <h1><%=ab.getTimer()%>MIN</h1><br><br>
    	<button onclick="myFunction()">Click Here To Change Timer</button><br><br>
		<div id="myDIV" style="display: none">
		<form action="timerupdate.jsp" method="post">
		Enter New Timer :<input type="text" name="timer">
