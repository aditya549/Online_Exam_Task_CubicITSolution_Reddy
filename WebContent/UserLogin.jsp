...
<hr style="margin-left: 200px;margin-right: 200px;border:outset;">
<hr style="margin-left: 200px;margin-right: 200px;border:outset;">
<h2 style="text-align: left;border: outset;margin-left: 200px;margin-right: 1000px"><a href="index.html">Home</a></h2>
<table align="center">
<tr>
	<td align="center" width="500" Style="border-right: outset;border-left: double">
	<p style="text-align: center;">***Already Registered Please Login Here</p>
	<h2 style="text-align: center;border: outset;margin-left: 100px;margin-right: 100px">Existing User Login</h2>
	...
	<td align="center" width="500" Style="border-left: double;border-right: double">
	<p style="text-align: center;">***New User Please Register Here</p>
	<h2 style="text-align: center;border: outset;margin-left: 100px;margin-right: 100px">New User Registration</h2>
